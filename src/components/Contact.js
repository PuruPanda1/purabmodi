  ...
  return (
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          <h1 className='mb-4 text-6xl font-sans tracking-tight text-center text-gray-900 dark:text-white '>Contact Us</h1>
          <p className="mt-4 mb-8 lg:mb-16 font-light text-center font-sans text-gray-500 dark:text-gray-400 sm:text-xl">Drop us a line! We’ll set up a time to chat over the phone or in-person to know more about your interests. All discussions can be done over the phone or in person.</p>
